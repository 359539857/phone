 ...
 */
public class WrapRequestMappingHandlerAdapter extends AbstractHandlerMethodAdapter implements BeanFactoryAware,
		InitializingBean {
	 ...
	 * Default constructor.
	 */
	public WrapRequestMappingHandlerAdapter() {
	...
	protected final ModelAndView handleInternal(HttpServletRequest request,
		...
		wrapRequest(request, response, handlerMethod);
	...
	private void wrapRequest(HttpServletRequest request, HttpServletResponse response,
			HandlerMethod handlerMethod){
		Object object = handlerMethod.getBean();
		if(object instanceof WrapRequest){
			ReflectUtil.setFieldValue(object, "request", request);
			ReflectUtil.setFieldValue(object, "response", response);
		}
	}
