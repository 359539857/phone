...
import org.redmine.ta.RedmineCommunicationException;
...
import org.redmine.ta.internal.Transport;
 ...
 * 
 */
public class WorkRemineManager {
    ...
    public WorkRemineManager(String uri) {
        this(uri, null, null);
    }

    public WorkRemineManager(String uri, String login, String password) {
		this.transport = new WorkTransport(new URIConfigurator(uri, null));
     ...
     */
    public WorkRemineManager(String host, String apiAccessKey) {
		this.transport = new WorkTransport(new URIConfigurator(host, apiAccessKey));
    }
    ...
    public List<Project> getProjects() throws RedmineException {
        try {
			return transport.getObjectsList(Project.class,true,
    ...
    public List<Issue> getIssuesBySummary(String projectKey, String summaryField) throws RedmineException {
        if ((projectKey != null) && (projectKey.length() > 0)) {
			return transport.getObjectsList(Issue.class,true,
    ...
    public List<Issue> getIssues(Map<String, String> pParameters) throws RedmineException {
		...
		return transport.getObjectsList(Issue.class, params,true);
    }
    ...
    public List<User> getUsers() throws RedmineException {
		return transport.getObjectsList(User.class,true);
    }
    ...
    public List<TimeEntry> getTimeEntries() throws RedmineException {
		return transport.getObjectsList(TimeEntry.class,true);
    }
    
    public List<TimeEntry> getLastSevenDayTimeEntries() throws RedmineException {
		return transport.getObjectsList(TimeEntry.class,false);
    }
    ...
    public List<SavedQuery> getSavedQueries(String projectKey) throws RedmineException {
		...
		return transport.getObjectsList(SavedQuery.class, params,true);
    }
    ...
    public List<SavedQuery> getSavedQueries() throws RedmineException {
		return transport.getObjectsList(SavedQuery.class,true);
    }
    ...
    public List<IssueStatus> getStatuses() throws RedmineException {
		return transport.getObjectsList(IssueStatus.class,true);
    }
    ...
    public List<Tracker> getTrackers() throws RedmineException {
		return transport.getObjectsList(Tracker.class,true);
    }
    ...
    public List<News> getNews(String projectKey) throws RedmineException {
		...
		return transport.getObjectsList(News.class, params,true);
    }
